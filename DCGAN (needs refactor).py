# -*- coding: utf-8 -*-
"""
Created on Fri Oct 27 01:14:30 2017
...
d_trainer_fake = tf.train.GradientDescentOptimizer(0.0001).minimize(d_loss_fake, var_list=d_vars)
d_trainer_real = tf.train.GradientDescentOptimizer(0.0001).minimize(d_loss_real, var_list=d_vars)
